...
private:
     ...
     */
    int editor(int i, int j, const string &word1, const string &word2)
    {
...
public:
    int minDistance(string word1, string word2)
    {
        ...
        return editor(word1.size() - 1, word2.size() - 1, word1, word2);
    }
};
